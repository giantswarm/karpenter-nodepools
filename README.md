[![CircleCI](https://dl.circleci.com/status-badge/img/gh/giantswarm/karpenter-nodepools/tree/main.svg?style=svg)](https://dl.circleci.com/status-badge/redirect/gh/giantswarm/karpenter-nodepools/tree/main)

[Read me after cloning this template (GS staff only)](https://handbook.giantswarm.io/docs/dev-and-releng/app-developer-processes/adding_app_to_appcatalog/)

# karpenter-nodepools chart

Giant Swarm offers a karpenter-nodepools App which can be installed in workload clusters.
Here, we define the karpenter-nodepools chart with its templates and default configuration.
